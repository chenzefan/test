...
function EntityScript:GetDisplayName()
    ...
    local wet = GetWorld().components.moisturemanager:IsWorldWet() and not GetWorld().components.moisturemanager:IsEntityDry(self)
    if self.components.moisturelistener then
        wet = self.components.moisturelistener:IsWet()
    end
