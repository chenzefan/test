return 
{
    ...
    DESCRIBE=
    {
        ...
        MONSTERMEAT = "I don't think it's safe to eat this.",
        MONSTERLASAGNA = "Lasagna or no, I don't think it's safe to eat this.",
        ...
        RESURRECTIONSTONE = "There is something unnatural about that stone.",
        ROBIN =
        {
            GENERIC = "Cardinalis! Beautiful plumage.",
            HELD = "He will be my friend.",
        },
        ROBIN_WINTER =
        {
        ...
        SHOVEL = "It's shovel. Surely you've seen one before?",
        ...
        FISHINGROD = "I've read all about fishing, this should be a snap.",
        ...
        DECIDUOUSTREE = 
        {
            GENERIC = "A generically deciduous tree.",
    ...
    ANNOUNCE_RESEARCH = "Every bit of information is useful.",
