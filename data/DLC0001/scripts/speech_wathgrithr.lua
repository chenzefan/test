return {
	...
	ANNOUNCE_DAMP = "The tears of gods fall upon me.",
	ANNOUNCE_WET = "Does all this rain count as a bath?",
	ANNOUNCE_WETTER = "Time to seek relief from the wet.",
	...
	{		
		...
		WEBBERSKULL = "He seems worthy of true rest.",
