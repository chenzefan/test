...
local function MakeMushroom(data)
    ...
    local function OnFullMoon(inst, night)
        if night then
    ...
    local function mushfn(Sim)
        ...
        inst:ListenForEvent("fullmoon", function(world, data) OnFullMoon(inst, true) end, GetWorld())

        inst:ListenForEvent("daytime", function(world, data) OnFullMoon(inst, false) end, GetWorld())
