return {
	...
	ANNOUNCE_SHELTER = "Thanks for the protection, tree!",
	ANNOUNCE_THORNS = "Ow!",
	...
	ANNOUNCE_DAMP = "Rain, rain, go a-way...",
	ANNOUNCE_WET = "It's a bit wet out.",
	...
	DESCRIBE =
	{
        ...
        GLOMMERGLAND = "The petals shimmer in the light.",
		...
		WEBBERSKULL = "Poor guy. I should put him to rest.",
		...
		EYEBRELLA =	"It will watch over me.",
		DEPLETED_GRASS =
		{
		...
		DECIDUOUSTREE = 
		{
			...
			POISON = "It looks unhappy about something.",
