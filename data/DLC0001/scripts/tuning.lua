...
function Tune(overrides)
	...
	TUNING =
	{
		...
		STARTING_TEMP = 35,
		OVERHEAT_TEMP = 70,
		TARGET_SLEEP_TEMP = 30,
		MIN_ENTITY_TEMP = -20,
		MAX_ENTITY_TEMP = 90,
		WARM_DEGREES_PER_SEC = 1,
		THAW_DEGREES_PER_SEC = 5,
		ICE_EAT_TEMP_REDUCTION = 10,
	    ...
	    MIN_HAIRBALL_FRIEND_INTERVAL = 10,
	    MAX_HAIRBALL_FRIEND_INTERVAL = 30,
	    MIN_HAIRBALL_NEUTRAL_INTERVAL = 60,
	    MAX_HAIRBALL_NEUTRAL_INTERVAL = 240,

		FERTILIZER_USES = 10,

		ICEHAT_COOLER = -10,
		WATERMELON_COOLER = 10,
