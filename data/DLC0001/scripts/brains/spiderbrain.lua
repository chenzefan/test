...
function SpiderBrain:OnStart()
    local root =
        PriorityNode(
        {
            ...
            IfNode(function() return GetSeasonManager() and GetSeasonManager():IsSpring() end, "IsSpring", 
                ChaseAndAttack(self.inst, MAX_CHASE_TIME*TUNING.SPRING_COMBAT_MOD)),
            IfNode(function() return GetSeasonManager() and not GetSeasonManager():IsSpring() end, "IsNotSpring", 
