local assets=
{
    ...
    Asset("IMAGE", "data/inventoryimages/tallbirdegg.tex"),
    Asset("IMAGE", "data/inventoryimages/tallbirdegg_cracked.tex"),
    Asset("IMAGE", "data/inventoryimages/tallbirdegg_cooked.tex"),
}
