...
STRINGS=
{
    ...
    NAMES =
    {
        ...
        DECIDUOUS_ROOT = "Birchnut Root", --This is never used in game: this is for morgue screen (deaths by root)
        ACORN = "Birchnut",
