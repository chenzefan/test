...
Recipe("icestaff", {Ingredient("spear", 1),Ingredient("bluegem", 1)}, RECIPETABS.MAGIC,  2)
Recipe("amulet", {Ingredient("goldnugget", 6), Ingredient("nightmarefuel", 4),Ingredient("redgem", 1)}, RECIPETABS.MAGIC,  3)
